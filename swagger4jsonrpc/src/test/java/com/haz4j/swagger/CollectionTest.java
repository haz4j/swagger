...
public class CollectionTest {
    ...
    public void listAllTest() {
        ...
        Assert.assertThat(json, Matchers.is("{\"com/haz4j/swagger4jsonrpc\":\"2.0\",\"host\":\"" +
                HOST_NAME +
                "\",\"basePath\":\"/\",\"tags\":[{\"name\":\"collections\",\"description\":\"Api collections\"}],\"paths\":{\"/v1/collection#0\":{\"post\":{\"tags\":[\"collections\"],\"summary\":\"listAll\",\"description\":\"\",\"operationId\":\"/v1/collection#0\",\"consumes\":[\"application/json\"],\"produces\":[\"application/json\"],\"parameters\":[{\"in\":\"body\",\"name\":\"JsonRpc\",\"description\":\"JsonRpc\",\"required\":true,\"schema\":{\"type\":\"object\",\"properties\":{\"id\":{\"type\":\"integer\",\"format\":\"int64\"},\"jsonrpc\":{\"type\":\"string\",\"description\":\"jsonrpc version\",\"default\":\"2.0\"},\"method\":{\"type\":\"string\",\"example\":\"listAll\"}}}}],\"responses\":{}}}},\"definitions\":{}}"));
    }
}